...
class ChatbotApp:
    ...
    def generate_explanation(self, sentiment, polarity, subjectivity):
        ...
        explanation += f"It generally expresses a {'positive' if sentiment == 'Positive' else 'neutral'} sentiment. "
        explanation += f"The polarity score is {polarity:.2f}. "
        explanation += f"The subjectivity score is {subjectivity:.2f}."
        return explanation
